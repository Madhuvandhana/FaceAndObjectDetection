...
/**
 * @see https://github.com/googlesamples/mlkit
...
object BitmapUtils {
    ...
    fun getCroppedBitMap(imageProxy: ImageProxy, frameMetadata: FrameMetadata): Bitmap? {
        val nv21Buffer: ByteBuffer? = imageProxy.image?.planes?.let { it1 ->
